...
//    var ingredientsUiChange: MutableList<IngredientUi> = viewModel.ingredientsUi.value
    ...
    Row(
        ...
        Column() {
            ...
            // Черта под Row
            Divider(
                color = Color(0xFF1E364F),           // цвет линии
...
//                    ingredientsUi2 = ingredientsUiChange
                    ...
                    Log.d(
                        "INGREDIENT-UI",
                        "RecipeIngredientsBlock: ingredientsUiChange: ${ingredientsUiChange}"
                    )
            ...
            Log.d(
                "INGREDIENT-UI",
                "RecipeIngredientsBlock: selectedIngredient-2: ${selectedIngredient}"
            )
        }
//    }   //  Row
}